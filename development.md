...
When you deploy it to production (or staging), it will deploy each service in a different subdomain, like `api.synthralos.ai` for the backend and `dashboard.synthralos.ai` for the frontend.
