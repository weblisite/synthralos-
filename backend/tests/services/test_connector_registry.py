...
class TestConnectorRegistry:
    ...
    def test_register_connector_invalid_manifest(self, connector_registry, db_session):
    ...
    def test_register_connector_duplicate_slug(
        ...
        connector_registry.register_connector(db_session, manifest=valid_manifest)
    ...
    def test_get_connector_success(
        ...
        retrieved = connector_registry.get_connector(db_session, slug="test-connector")

        assert retrieved is not None
        assert retrieved.id == connector.id
        assert retrieved.slug == "test-connector"

    def test_get_connector_not_found(self, connector_registry, db_session):
        """Test retrieving non-existent connector."""
        with pytest.raises(ConnectorNotFoundError):
            connector_registry.get_connector(db_session, slug="nonexistent")

    def test_list_connectors(self, connector_registry, db_session, valid_manifest):
    ...
    def test_validate_manifest_success(self, connector_registry, valid_manifest):
        """Test manifest validation with valid manifest."""
        # Should not raise an exception
        connector_registry.validate_manifest(valid_manifest)

    def test_validate_manifest_missing_fields(self, connector_registry):
    ...
    def test_validate_manifest_invalid_slug(self, connector_registry):
    ...
    def test_validate_manifest_invalid_version(self, connector_registry):
