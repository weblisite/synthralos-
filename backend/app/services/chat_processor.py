...
from app.agents.router import AgentRouter, default_agent_router
from app.models import Workflow, WorkflowCreate, WorkflowNode
...
class ChatProcessor:
    ...
    async def _process_with_openai(self, mode: str, content: str, user_id: str) -> dict[str, Any]:
