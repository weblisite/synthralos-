...
class SecretsService:
    ...
    def _http_create_secret(self, secret_name: str, secret_value: str, environment: str, path: str):
    ...
    def delete_secret(
        ...
        """
        if not self.client:
            logger.warning(f"Infisical not available, secret '{secret_key}' not deleted")
            return
