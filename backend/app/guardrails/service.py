...
from app.guardrails.validators import PydanticValidator, ValidationError, ZodValidator
...
class GuardrailsService:
    ...
    def _check_availability(self) -> None:
        ...
        try:
            ...
            logger.warning("GuardrailsAI is not installed. Install with: pip install guardrails-ai")
            self._guardrailsai_available = False
