...
from app.models import Connector, ConnectorVersion, User
    ...
    *,
    ...
    try:
        ...
        default_wazuh_client.log_audit_event(
            ...
            success=True,
            metadata={
                "connector_slug": manifest.get("slug"),
                "connector_name": manifest.get("name"),
        ...
        result.append(
            {
                ...
                "created_by": str(connector.created_by)
                if connector.created_by
                else None,
...
def update_connector_status(
    ...
    try:
        ...
        default_wazuh_client.log_audit_event(
            ...
            metadata={
                "connector_slug": slug,
                "old_status": connector.status,  # Note: This will be the new status after update
    ...
    try:
        ...
        default_wazuh_client.log_audit_event(
            ...
            metadata={
                ...
                "was_platform": connector.is_platform,
                "status": connector.status,
            },
        )
