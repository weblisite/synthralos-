...
def get_dashboard_stats(
    ...
    # OSINT Statistics
    osint_streams = session.exec(
        select(func.count(OSINTStream.id))
    ).one()
    ...
    return {
        ...
        "executions": {
            ...
            "success_rate": (
                ...
                if execution_stats["total"] > 0 else 0
            ),
        },
        "agents": {
        ...
        "scraping": {
            ...
            "success_rate": (
                ...
                if scraping_stats["total"] > 0 else 0
            ),
        },
        "browser": {
