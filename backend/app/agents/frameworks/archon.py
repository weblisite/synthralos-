    ...
    def _check_availability(self) -> None:
        ...
        try:
            if settings.OPENAI_API_KEY:
                ...
                logger.info("Archon framework is available (using OpenAI with self-healing)")
            else:
    ...
    def execute_task(
        ...
        if not self.is_available:
            return {
                ...
                "result": None,
                "context": context or {},
                "logs": ["Archon framework not available. Please configure OPENAI_API_KEY."],
        ...
        try:
            ...
            logs = [f"Starting Archon self-healing execution"]
...
3. Execution result"""
                    ...
                    try:
                        ...
                        logs.append(f"Healing attempt {attempt + 1} failed: {str(healing_error)}")
