    ...
    def _check_availability(self) -> None:
        ...
        try:
            if settings.OPENAI_API_KEY:
                ...
                logger.info(
                    "AutoGen framework is available (using OpenAI function calling)"
                )
            else:
    ...
    def execute_task(
        ...
        if not self.is_available:
            return {
                ...
                "context": context or {},
                "logs": [
                    "AutoGen framework not available. Please configure OPENAI_API_KEY."
                ],
        ...
        try:
            ...
            logs = ["Starting AutoGen tool-calling execution"]
            ...
            for turn in range(max_turns):
                ...
                if message.tool_calls:
                    for tool_call in message.tool_calls:
                        ...
                        logs.append(
                            f"Tool call: {tool_name} with args: {tool_args[:100]}..."
                        )
