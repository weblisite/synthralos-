    ...
    def execute_task(
        ...
        if not self.is_available:
            return {
                ...
                "result": None,
                "context": context or {},
                "logs": ["MetaGPT framework not available. Please configure OPENAI_API_KEY."],
        ...
        try:
            ...
            for i, role in enumerate(roles):
                role_desc = role_descriptions.get(role, f"You are a {role}. Your role is to contribute to the task.")
