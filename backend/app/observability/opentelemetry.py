...
try:
    ...
    logger.warning("OpenTelemetry packages not installed. Observability features will be limited.")
...
def setup_opentelemetry(app: Any | None = None) -> None:
    ...
    try:
        ...
        logger.info(f"✅ OpenTelemetry configured (Signoz endpoint: {settings.SIGNOZ_ENDPOINT})")
